...
namespace RobotsVsDinosaursProject
{
    class Battlefield
    {
        ...
        public void AttackOneFullRound()
        {
            ...
            fleet.robots[1].AttackDino(herd.dinos[1]);
        ...
        public void GiveTotalStats()
        {
            ...
            Console.WriteLine(herd.dinos[1].type + " has " + herd.dinos[1].health + " health points and " + herd.dinos[1].energy + " energy points");
        ...
        // fleet.robots[0].health + fleet.robots[1].health + fleet.robots[2].health > 0
        // herd.dinos[0].health + herd.dinos[1].health + herd.dinos[2].health > 0
        public void AnnounceGameWinner()
        {
            ...
            else if (herd.dinos[0].health <= 0 &&  herd.dinos[1].health <= 0 && herd.dinos[2].health <= 0)
            {
